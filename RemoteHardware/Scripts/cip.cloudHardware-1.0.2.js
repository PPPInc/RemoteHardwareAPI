/*NOTE:  
MJ 9/4/2016
This is a version designed for module loading via Require.js and is currently only used by BridalLive.
*/

/*
 *
 * Charge It Pro Cloud Hardware Library v1.0.2
...
(function (factory) {
    ...
    return new (function () {
         ...
         */
        var OnResultFunction; //Function to be called when transaction results are returned from cloud hardware.
        var OnEchoFunction; //Function to be called when an echo response is returned from cloud hardware.
        var OnConfigurationDownloadedFunction; //Function to be called when the configuration has been downloaded.
         ...
         */
        var isTestMode = false; //Bool value indicating whether test mode is on or off.
        var userName; //Unique name for this connection.
        var controllerName; //Name of the cloud hardware controller to send transactions.
        var locationId; //LocationId for this connection.
        var devices; //Array of cloud hardware devices that transactions can be processed on.
        ...
        var echoFunction; //Call this function to test connectivity between your web-based POS and the cloud hardware controller.
        ...
        var pingFunction; //Call this function to ping a device and verify it is connected properly.
